...
<body>
  	<header class="youtubeHeader">
  		<div class="youtubelogo">
  				...
  				<svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" class="youtubeLogoSVG"><g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" class="style-scope ytd-topbar-logo-renderer">
   ...
   <div class="youtubeHeaderIcons">
     <div class="youtubeHeaderIcon">
      <i class="fa fa-video-camera"></i>
			...
			<div class="youtubeHeaderIcon avatar">
				<img class="youtubeHeaderAvatarIcon" src="https://yt3.ggpht.com/ytc/AKedOLS_mpO0QdaC_ABSev3Rsck2FGEffk-veuy99RdOz1M=s88-c-k-c0x00ffffff-no-rj">
			</div>
		</div>
	</header>

  <!--Header section ends here -->
   <!--Bottom (sidebar and videos) section ends here -->

  <div class="youtubeBottomSection">
    <!-- Sidebar section starts here-->
    <div class="youtubeSidebar">
    <div class="youtubeSidebarField">
    ...
    <div class="youtubeSidebar_hr"></div>
    ...
    <div class="youtubeVideos">
        <div class="youtubeVideo">
          <img class="youtubeVideothumbnail"  src="https://i.ytimg.com/vi/p5V78yI14dI/hqdefault.jpg?sqp=-oaymwEcCNACELwBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBt2JOzcsz_HuLW7gpqfR-chqwl6w"> 
            <div class="youtubeVideoDetails"> 
                <img class="youtubeChannelThumbnail" src="https://yt3.ggpht.com/QqtEVz01LJe-BSXwiQWqiM7zsLJJ7-JYrSvVysoDB7qkpJ2_Q1ivQ0CO8715E17FBsz1IYbmBQ=s68-c-k-c0x00ffffff-no-rj">
                <div class="youtubeChannelText">
                  <p class="youtubeVideoTitle">Netflix Clone in React Native</p>
                  <p class="youtubeChannelName">Decoder Himanshu</p>
                  <p class="youtubeVideoViews">20M views</p>
                </div>
            </div>
        </div>
        <div class="youtubeVideo">
        ...
        <div class="youtubeVideo">
          <a href="https://www.youtube.com/watch?v=0pHUPgCoJ30">
          <img class="youtubeVideothumbnail"  src="https://static.toiimg.com/thumb/msid-75216961,imgsize-168605,width-800,height-600,resizemode-75/75216961.jpg"> 
        </a>
            <div class="youtubeVideoDetails"> 
                <img class="https://yt3.ggpht.com/VA-Rx2Xx9Q-Y1o6c-EB_ZO1qZF-J8rlzz1fXYvqwcye8ZOK4LzqJgEb_27L94enFIC-CV8oitQ=s88-c-k-c0x00ffffff-no-rj">
                <div class="youtubeChannelText">
                  <p class="youtubeVideoTitle">Chhota Bheem - Kaun Jeetega Laddoo | Adventure Videos</p>
                  <p class="youtubeChannelName">Abhiraj Singh</p>
                  <p class="youtubeVideoViews">1,419,872 views</p>
                </div>
            </div>
        </div>
        <div class="youtubeVideo">
          <a href="https://www.youtube.com/watch?v=fK62ZAELFmA">
          <img class="youtubeVideothumbnail"  src="https://i.ytimg.com/vi/fK62ZAELFmA/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLA9Z1HeJQaZPTpFHgLei9livXyJ4A">
          </a> 
            <div class="youtubeVideoDetails"> 
                <img class="youtubeChannelThumbnail" src="https://yt3.ggpht.com/ytc/AKedOLQn_cXEr-INDtCQ22sf7D5S1P_KkpllUxKK9-ebcg=s88-c-k-c0x00ffffff-no-rj">
                <div class="youtubeChannelText">
                  <p class="youtubeVideoTitle">Baarish Ban Jaana ( Bhojpuri ) - Pawan Singh, Payal Dev </p>
                  <p class="youtubeChannelName">Bhojpuri World</p>
                  <p class="youtubeVideoViews">8345678 views</p>
                </div>
            </div>
        </div>
        <div class="youtubeVideo">
        ...
        <div class="youtubeVideo">
         ...
         <div class="youtubeVideo">
          <img class="youtubeVideothumbnail"  src="https://i.ytimg.com/vi/p5V78yI14dI/hqdefault.jpg?sqp=-oaymwEcCNACELwBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBt2JOzcsz_HuLW7gpqfR-chqwl6w"> 
            <div class="youtubeVideoDetails"> 
                <img class="youtubeChannelThumbnail"  src="https://yt3.ggpht.com/ytc/AKedOLTUfbbWnB32S6Z4kmZnhLAoLu3XJcaw9cdbaKbXuw=s68-c-k-c0x00ffffff-no-rj">
                <div class="youtubeChannelText">
                  <p class="youtubeVideoTitle">Netflix Clone in React Native || Learn React Native BE champ</p>
                  <p class="youtubeChannelName">Decoder Himanshu</p>
                  <p class="youtubeVideoViews">20M views</p>
                </div>
            </div>
         ...
         <div class="youtubeVideo">
          <img class="youtubeVideothumbnail"  src="https://i.ytimg.com/vi/2pH4AwiRnmg/hqdefault.jpg?sqp=-oaymwEcCNACELwBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBaOGBmd6lrs_pc5KxXburygw7B0g"> 
            <div class="youtubeVideoDetails"> 
                <img class="youtubeChannelThumbnail"  src="https://yt3.ggpht.com/ytc/AKedOLTUfbbWnB32S6Z4kmZnhLAoLu3XJcaw9cdbaKbXuw=s68-c-k-c0x00ffffff-no-rj">
                <div class="youtubeChannelText">
                 <p class="youtubeVideoTitle">Netflix Clone in React Native</p>
